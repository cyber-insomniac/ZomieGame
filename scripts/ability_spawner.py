...
class AbilitySpawner:
    ...
    def spawn_ability(self):
        ...
        random_ability = random.randrange(0,len(self.abilityTypes))

        new_ability = ability(random_x, 0, 50, 50, self.abilityTypes[random_ability])
    ...
    def update(self, dt):
        ...
        AbilitySpawner.abilities = [a for a in AbilitySpawner.abilities if a.distance >= 1.5 and not a.pickedUp]
